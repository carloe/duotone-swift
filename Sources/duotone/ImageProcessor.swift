...
class ImageProcessor {
    static let functionName = "shaderKernel"
    ...
    static func colorMap(_ image: NSImage, darkColor: NSColor, lightColor: NSColor, contrast: CGFloat = 0.5, blend: CGFloat = 0.5) throws -> NSImage {
        ...
        var lightColor = float3From(color: lightColor)
        var darkColor = float3From(color: darkColor)
        ...
        return try cgImage(from: outTexture)
    }
